...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <ul class="offcanvas__widget">
            <li><i class="fa fa-map-marker"></i> 57, Awolowo way Ikeja Lagos Nigeria </li>
            <li><i class="fa fa-phone"></i> 07031252662</li>
            <li><i class="fa fa-envelope"></i> Info@smc.com.ng</li>
        </ul>
